...
const RESPONSE_CODES = {
  ...
  LOGOUT_FAILED: { code: 'LOGOUT_FAILED', message: 'Failed to log out', success: false },
  ...
  LOGOUT_SUCCESSFUL: { code: 'LOGOUT_SUCCESSFUL', message: 'Logout Successful', success: true },
